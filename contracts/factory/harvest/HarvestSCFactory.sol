...
contract HarvestSCFactory is HarvestFactoryBase, IHarvestSCStrategyFactory {
    constructor(
    ...
    function createStrategy(     
        ...
        IInitializableHarvestSC(address(_proxy)).initialize(
            harvestRewardVault,
             harvestRewardPool,
            sushiswapRouter,
            _harvestfToken, 
        ...
        IInitializableHarvestSC(address(_proxy)).grantOwnerRole(_ownerAccount);
